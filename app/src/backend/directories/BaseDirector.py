...
class BaseDirector:
    ...
    def load_home(request):
        ...
        development_projects_message = 'There is no any development project' if len(development_projects) == 0 else ''
        production_projects_message = 'There is no any production project' if len(production_projects) == 0 else ''
        archive_projects_message = 'There is no any archive project' if len(archive_projects) == 0 else ''
