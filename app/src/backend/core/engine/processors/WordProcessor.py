...
# from gensim.mlmodels import Word2Vec
from nltk import word_tokenize, pos_tag
from nltk.corpus import wordnet

from app.src.backend.constants.DATAPROCESSING_CONSTANTS import delete_actions, combine_actions, actions_list, ignorance_words, \
    sum_actions
